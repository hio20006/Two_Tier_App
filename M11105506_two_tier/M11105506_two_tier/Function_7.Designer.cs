...
namespace M11105506_two_tier.Function_7TableAdapters {
    ...
    public partial class system_infoTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = @"DELETE FROM [system_info] WHERE (([List] = @Original_List) AND ([SystemID] = @Original_SystemID) AND ((@IsNull_SiteID = 1 AND [SiteID] IS NULL) OR ([SiteID] = @Original_SiteID)) AND ((@IsNull_Totalcores = 1 AND [Totalcores] IS NULL) OR ([Totalcores] = @Original_Totalcores)))";
